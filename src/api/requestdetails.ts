...
export default (router) => {
  ...
  router.get('/requests/:type?', async (req: Request, res: Response) => {
    ...
    const details = await BussinesLogicService.FetchPeldataByCompany(CompanyResult.company_name);
    ...
    const company_details = await BussinesLogicService.FetchPelCompanyData(pel_search_ids)
